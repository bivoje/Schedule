...
printCellValue (CellText text) = T.putStrLn text
printCellValue (CellDouble db) = putStrLn (show db)
printCellValue (CellBool b) = putStrLn (show b)
printCellValue (CellRich rtr) = putStrLn "richtext"
printCellValue (CellError err) = putStrLn (show err)
